...
1. the dataset used can be found at http://mba.tuck.dartmouth.edu/pages/faculty/ken.french/data_library.html I used the log return values instead of real return as the log returns are normally distributed. This statistical property allows me to use a GBM model to simulate future returns.
